...
class ManagerMain:
    ...
    def edit_product_frame(self):
        ...
        if not self.prod_select:
            ...
            self.edit_prod_window.grab_set()
...
class SalesRegister:
    ...
    def trans_reg_show(self):
        ...
        if not reg:
            ...
            for x in reg:
                prod_name = POSdatabase.search_prod_db_by_id(x[1])[2]
    ...
    def edit_qty_frame(self, ev):
        ...
        if not prod_sel:
            ...
            self.edit_quant_window.grab_set()
            ...
            self.subtotal = Entry(self.edit_quant_window, font=("Bebas Neue", 17), bg="white", fg="black",
                                  textvariable=self.subtotalamt)
            self.subtotalamt.set(self.price_prod.get() * self.edit_quant.get())
