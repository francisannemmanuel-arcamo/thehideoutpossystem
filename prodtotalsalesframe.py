...
class ProdTotalSales:
    def __init__(self, frame):
        ...
        totalsales_lbl = Label(self.frame, font=("Bebas Neue", 14), bg="#0A100d", fg="white", text="Total Sales")
        totalsales_lbl.place(height=40, width=110, x=760, y=4)
        totalsales = Entry(self.frame, textvariable=self.totalsales, font=("Bebas Neue", 15))
        totalsales.place(height=40, width=170, x=870, y=4)
        ...
        totalsales.config(state=DISABLED)
